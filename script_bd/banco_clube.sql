...
CREATE TABLE tecnico (
    ...
    epecializacao VARCHAR(30) NOT NULL,
...
CREATE TABLE tecnico_telefone (
    registro_tecnico_tel INT NOT NULL AUTO_INCREMENT,
    telefone VARCHAR(20),
...
CREATE TABLE tecnico_endereco (
    registro_tecnico_end INT NOT NULL AUTO_INCREMENT,
...
-- MUDOU AQUI PARA BAIXO

CREATE TABLE esporte(
    esporte_cod SMALLINT AUTO_INCREMENT,
